...
def plot_multiple(value, num_proc=4, num_snaps=10, snap_offset=0, save_path='',snap_path='', axes_plot=[0,2], 
    ...
    outfile = os.path.join(save_path, f"multi_{value}50.png")
    plt.savefig(outfile, dpi=600, bbox_inches="tight")

save_path = '/home/dc-naza3/rds/rds-dirac-dp317-rvYpA2WHqGs/rion/snap-plotting/tests/rhov2/'
snap_path = '/home/dc-naza3/rds/rds-dirac-dp317-rvYpA2WHqGs/rion/hires/50/'
...
plot_multiple('nH_cm', 
              ...
              snap_path=snap_path,
               num_snaps=14, snap_offset=0, axes_plot=[0, 2], box=[0.5, 0.5], proj=False, proj_fact=0.3, 
               cmap='jet', weighted=True, weights='rho',vrange=(1e-3, 3e2))
