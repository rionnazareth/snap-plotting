...
plot_multiple('rho', num_proc=1, save_path='/cosma8/data/dp317/dc-naza3/gasCloudNfw/snap-plotting/plots_new', 
              snap_path='/cosma8/data/dp317/dc-naza3/homogeneous/rho_vary/0.5',
               num_snaps=14, snap_offset=0, axes_plot=[0, 2], box=[1,1], proj=False, proj_fact=0.3, 
